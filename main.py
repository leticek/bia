...
def main():
    vizual = vizualizer.Vizualizer(dimension=2, lower_bound=-4, upper_bound=4)
    # vizual.hill_climb(functions=functions, neighbour_count=10, sigma=0.5, total_iterations=100000)
